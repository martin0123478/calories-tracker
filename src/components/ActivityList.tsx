...
export const ActivityList = ({ activities, dispatch }: ActivityListProps) => {
    const activitiesIsEmpty = useMemo(() => activities.length === 0, [activities])
    ...
    return (
        <>
...

            {
                ...
                activitiesIsEmpty ? <p className="text-center">No hay Actividades aún</p> :
                        ...
                        <div key={activity.id} className="px-5 py-10 bg-white mt-5 flex justify-between ">
                            ...
                            <div className="flex gap-5 item-center ">
                                ...
                                <button onClick={() => dispatch({ type: 'delete-activity', payload: { id: activity.id } })}>
                                    <XCircleIcon className="h-8 w8 text-red-500" />
                                </button>
